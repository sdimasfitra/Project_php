...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container" style="margin-left:105px;">
            <a class="navbar-brand" href="index.php">
                <img class="rounded-pill" alt="Logo" style="width:40px;" src="">
    ...
    <div class="container">
        <form class="d-flex" action="" method="post">
            <input class="form-control me-2 input-sm" style="width: 300px;" type="text" name="keyword" placeholder="Masukkan keyword.." autocomplete="off">
